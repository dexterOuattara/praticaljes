...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-6" style="background-color: #3498db;padding-top: 100px;padding-bottom: 220px;color: white">
        ...
        <div class="col-md-6" style="padding-top: 80px;">
            <div class="card">
                <div class="card-header text-center">{{ __('I AM RECRUTER') }}</div>
