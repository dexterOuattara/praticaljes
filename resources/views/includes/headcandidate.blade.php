...
<div class="container body">
    <div class="main_container">
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view" style="background-color: #1ABB9C;color: white">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="{{ route('candidate.home') }}" class="site_title"><img src="{{asset('images2/faviconcodelin.png')}}" alt=""></i> <span>Code\n</span></a>
                </div>
                ...
                <div class="profile clearfix">
                    <div class="profile_pic"> <a href="myresume">
                            <img src="/storage/avatars/{{ Auth::user()->avatar }}" alt="..." class="img-circle profile_img">
                        </a>
                    </div>
                    <div class="profile_info">
                        <span>Welcome,</span>
                        <h2>{{ Auth::user()->last_name }} {{ Auth::user()->name }}</h2>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <!-- /menu profile quick info -->